 ...
 * <ul>
 * <li>
 *  The individual quotes can be on several lines, but at the end
 *  of each of these lines there must be a blank.
 * </li>
 * <li>
 *  When a line contains only a single dot, then the next line is
 *  the first line of another quote.
 * </li>
 * </ul>
 * <br><br>
 * 
